...
function DashProfile() {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        <h1 className=' text-center font-semibold text-3xl mb-10 mt-4'>Profile</h1>
        <form className='flex flex-col gap-5' >
            <div className='w-32 h-32 self-center cursor-pointer overflow-hidden rounded-full'>
            <img src={currentUser.photoURL} alt="user" className='rounded-full w-full h-full object-cover border-8 border-[lightgray] ' />
            </div>
